...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='autopark_system', executable='slot_estimator', name='slot_estimator', output='screen', parameters=[params]),
        Node(package='autopark_system', executable='serial_bridge', name='serial_bridge', output='screen', parameters=[params]),
        Node(package='autopark_system', executable='motion_executor', name='path_follower', output='screen', parameters=[params]),
